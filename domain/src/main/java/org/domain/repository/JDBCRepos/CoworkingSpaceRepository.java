package org.domain.repository.JDBCRepos;

import org.logger.Loggers;
import org.domain.exeption.CoworkingSpaceNotFoundException;
import org.domain.model.CoworkingSpace;
import org.domain.model.CoworkingSpaceType;
import org.domain.repository.EntityRepository;
import org.domain.sql.DatabaseConfigJDBC;
...
public class CoworkingSpaceRepository implements EntityRepository<CoworkingSpace, Long> {
    ...
    public CoworkingSpaceRepository(DatabaseConfigJDBC config) {
        this.config = config;
    }
